        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
            <div className="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 w-full max-w-md border border-gray-100">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-500 text-sm font-medium mt-2">Enter your details to access your account</p>
                </div>
                ...
                <p className="mt-8 text-center text-gray-500 font-medium text-sm">
                    Don't have an account? <Link to="/register" className="text-blue-600 font-black hover:underline ml-1">Register</Link>
                </p>
            </div>
        </div>
    );
